...
import { Check, Calendar, MapPin, Car, MessageCircle, Home, Phone, Star } from 'lucide-react';
    ...
    return (
      <div className="min-h-screen pt-24 flex items-center justify-center text-center px-4">
        <div>
          ...
          <Button onClick={() => navigate('/dashboard')}>View my trips</Button>
        </div>
      </div>
    );
  }

  const { car, startDate, endDate, totalDays, subtotal, serviceFee, total, pickupLocation } = state;
      ...
      <div className="max-w-2xl mx-auto px-4 sm:px-6 py-12">
        ...
        <div className="bg-white dark:bg-charcoal-900 rounded-3xl border shadow-xl overflow-hidden">
          ...
          <div className="bg-charcoal-900 dark:bg-gold-500 p-6 text-white">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-white/70 text-sm font-medium">Booking confirmed</p>
          ...
          <div className="p-6 space-y-6">
            ...
            <div className="space-y-2 text-sm">
              <h4 className="font-bold text-base mb-3">Payment summary</h4>
        ...
        <div className="mt-6 bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800 rounded-2xl p-5">
          ...
          <ul className="space-y-2 text-sm text-amber-700 dark:text-amber-500">
            ...
            <li className="flex items-start gap-2"><Check className="w-4 h-4 mt-0.5 flex-shrink-0" />Host will confirm within 1 hour (usually instant)</li>
