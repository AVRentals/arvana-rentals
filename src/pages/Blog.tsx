...
const POSTS = [
  {
    id: 1,
    slug: 'top-road-trips-2025',
    title: '10 Incredible Road Trips to Take in 2025',
    excerpt: 'From the Pacific Coast Highway to the Blue Ridge Parkway — we\'ve curated the most breathtaking drives across America for your next adventure.',
    category: 'Travel',
    readTime: '6 min read',
    date: 'Mar 18, 2025',
  ...
  },
  {
    ...
    title: 'Your Complete Guide to Renting an EV',
    excerpt: 'Thinking about going electric for your next trip? Here\'s everything you need to know — charging networks, range anxiety tips, and the best EVs to rent.',
    category: 'Tips',
    readTime: '8 min read',
    date: 'Mar 10, 2025',
  ...
  {
    id: 3,
    slug: 'luxury-car-weekends',
    title: 'How to Make a Luxury Car Weekend Worth It',
    excerpt: 'Renting a Ferrari or Lamborghini for the weekend is more accessible than you think. Here\'s how to plan an unforgettable experience.',
    category: 'Luxury',
    readTime: '5 min read',
    date: 'Feb 28, 2025',
  ...
  },
  {
    ...
    title: '7 Ways to Save Money on Your Next Car Rental',
    excerpt: 'Smart booking strategies, when to book, and which add-ons to skip — our guide to getting the best deal every time.',
    category: 'Tips',
    readTime: '4 min read',
    date: 'Feb 14, 2025',
  ...
  {
    id: 5,
    slug: 'best-cars-family-trips',
    title: 'The Best Cars for Family Road Trips',
    excerpt: 'Space, safety, and entertainment — we ranked the top family-friendly rentals available on Arvana Rentals for your next big family adventure.',
    category: 'Family',
    readTime: '7 min read',
    date: 'Jan 30, 2025',
